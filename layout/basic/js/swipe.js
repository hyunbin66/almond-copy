...
SwipeClient.prototype = {
  setup: function () {
    ...
    this.width = Math.ceil(
      "getBoundingClientRect" in this.container
    ...
    this.element.style.width =
      Math.ceil(this.slides.length * this.width) + "px";
  ...
  slide: function (index, duration) {
    ...
    style.MozTransform = style.webkitTransform =
      "translate3d(" + -(index * this.width) + "px,0,0)";
  ...
  prev: function (delay) {
    ...
    if (this.index)
      this.slide(this.index - 1, this.speed); // if not at first slide
  ...
  onTouchMove: function (e) {
    ...
    if (!this.isScrolling) {
      ...
      this.element.style.MozTransform = this.element.style.webkitTransform =
        "translate3d(" + (this.deltaX - this.index * this.width) + "px,0,0)";
